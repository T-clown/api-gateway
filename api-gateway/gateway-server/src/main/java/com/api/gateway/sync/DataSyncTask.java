...
public class DataSyncTask implements Runnable {
    ...
    private List<String> getEnabledPlugins(List<Instance> instanceList) {
        ...
        String plugins = metadata.getOrDefault("plugins", PluginEnum.DYNAMIC_ROUTE.getName());
        return Arrays.stream(plugins.split(",")).collect(Collectors.toList());
    }

    private List<ServiceInstance> buildServiceInstances(List<Instance> instances) {
